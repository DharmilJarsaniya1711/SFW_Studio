        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content position-relative">
            ...
            <button
              ...
              onClick={(e) => props.onCLickSwitchModal("confirm")}
            >
              Login
            </button>

            <div className="text-center font__size--16 text__16-1024 medium color__blue mt-4">
              <a
                href="#!"
                onClick={() => props.onCLickSwitchModal("forgotPassowrd")}
                className="d-inline-block color__blue"
              >
                Forgot Password?
              </a>
            </div>
